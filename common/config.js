...
// Cowmangler
config.COWMANGLER_HUB_ADDRESS = getEnv(env.COWMANGLER_HUB_ADDRESS, 'http://127.0.0.1');//'http://nightswatch.7kingdoms.me');

config.COWMANGLER_HUB_PORT = getEnv(env.COWMANGLER_HUB_PORT, '6666');//'8421');
