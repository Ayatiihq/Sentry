...
var CAPABILITIES = { browserName: 'firefox', seleniumProtocol: 'WebDriver', javascriptEnabled: true};
...
var iframeTester = function () {
  ...
  this.client = new webdriver.Builder().usingServer('http://192.168.1.10:4444/wd/hub')
